...
export const SnacksIcon = createIcon({
    displayName: 'SnacksIcon',
    viewBox: '0 0 24 24',
    path: (
        <>
            <rect width='24' height='24' fill='url(#pattern0_5002_136507)' />
            <defs>
                <pattern
                    id='pattern0_5002_136507'
                    patternContentUnits='objectBoundingBox'
                    width='1'
                    height='1'
                >
                    <use
                        xlinkHref='#image0_5002_136507'
                        transform='translate(0.125 0.125) scale(0.0078125)'
                    />
                </pattern>
                <image
                    id='image0_5002_136507'
                    width='96'
                    height='96'
